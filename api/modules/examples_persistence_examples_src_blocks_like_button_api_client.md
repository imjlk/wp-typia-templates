...
[examples/persistence-examples/src/blocks/like-button/api-client.ts:33](https://github.com/imjlk/wp-typia/blob/main/examples/persistence-examples/src/blocks/like-button/api-client.ts#L33)
...
[examples/persistence-examples/src/blocks/like-button/api-client.ts:26](https://github.com/imjlk/wp-typia/blob/main/examples/persistence-examples/src/blocks/like-button/api-client.ts#L26)
...
[examples/persistence-examples/src/blocks/like-button/api-client.ts:46](https://github.com/imjlk/wp-typia/blob/main/examples/persistence-examples/src/blocks/like-button/api-client.ts#L46)
