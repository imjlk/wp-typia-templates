[wp-typia - v1.0.0](../README.md) / [Modules](../modules.md) / packages/create/src/runtime/template-defaults

# Module: packages/create/src/runtime/template-defaults

## Table of contents

### Type Aliases

- [RemovedBuiltInTemplateId](packages_create_src_runtime_template_defaults.md#removedbuiltintemplateid)

### Variables

- [BUILTIN\_BLOCK\_METADATA\_VERSION](packages_create_src_runtime_template_defaults.md#builtin_block_metadata_version)
- [BUILTIN\_TEMPLATE\_METADATA\_DEFAULTS](packages_create_src_runtime_template_defaults.md#builtin_template_metadata_defaults)
- [COMPOUND\_CHILD\_BLOCK\_METADATA\_DEFAULTS](packages_create_src_runtime_template_defaults.md#compound_child_block_metadata_defaults)
- [REMOVED\_BUILTIN\_TEMPLATE\_IDS](packages_create_src_runtime_template_defaults.md#removed_builtin_template_ids)

### Functions

- [getBuiltInTemplateMetadataDefaults](packages_create_src_runtime_template_defaults.md#getbuiltintemplatemetadatadefaults)
- [isRemovedBuiltInTemplateId](packages_create_src_runtime_template_defaults.md#isremovedbuiltintemplateid)
- [getRemovedBuiltInTemplateMessage](packages_create_src_runtime_template_defaults.md#getremovedbuiltintemplatemessage)

## Type Aliases

### RemovedBuiltInTemplateId

Ƭ **RemovedBuiltInTemplateId**: typeof [`REMOVED_BUILTIN_TEMPLATE_IDS`](packages_create_src_runtime_template_defaults.md#removed_builtin_template_ids)[`number`]

Union of removed built-in template ids accepted by compatibility checks.

#### Defined in

[packages/create/src/runtime/template-defaults.ts:43](https://github.com/imjlk/wp-typia/blob/main/packages/create/src/runtime/template-defaults.ts#L43)
...
[packages/create/src/runtime/template-defaults.ts:4](https://github.com/imjlk/wp-typia/blob/main/packages/create/src/runtime/template-defaults.ts#L4)
...
[packages/create/src/runtime/template-defaults.ts:9](https://github.com/imjlk/wp-typia/blob/main/packages/create/src/runtime/template-defaults.ts#L9)
...
[packages/create/src/runtime/template-defaults.ts:31](https://github.com/imjlk/wp-typia/blob/main/packages/create/src/runtime/template-defaults.ts#L31)
...
[packages/create/src/runtime/template-defaults.ts:39](https://github.com/imjlk/wp-typia/blob/main/packages/create/src/runtime/template-defaults.ts#L39)
...
[packages/create/src/runtime/template-defaults.ts:51](https://github.com/imjlk/wp-typia/blob/main/packages/create/src/runtime/template-defaults.ts#L51)
...
[packages/create/src/runtime/template-defaults.ts:63](https://github.com/imjlk/wp-typia/blob/main/packages/create/src/runtime/template-defaults.ts#L63)
...
[packages/create/src/runtime/template-defaults.ts:77](https://github.com/imjlk/wp-typia/blob/main/packages/create/src/runtime/template-defaults.ts#L77)
