[wp-typia - v1.0.0](../README.md) / [Modules](../modules.md) / packages/wp-typia-project-tools/src/runtime/migrations

# Module: packages/wp-typia-project-tools/src/runtime/migrations

## Table of contents

### References

- [formatDiffReport](packages_wp_typia_project_tools_src_runtime_migrations.md#formatdiffreport)

### Functions

- [formatMigrationHelpText](packages_wp_typia_project_tools_src_runtime_migrations.md#formatmigrationhelptext)
- [parseMigrationArgs](packages_wp_typia_project_tools_src_runtime_migrations.md#parsemigrationargs)
- [runMigrationCommand](packages_wp_typia_project_tools_src_runtime_migrations.md#runmigrationcommand)
- [planProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#planprojectmigrations)
- [wizardProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#wizardprojectmigrations)
- [initProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#initprojectmigrations)
- [snapshotProjectVersion](packages_wp_typia_project_tools_src_runtime_migrations.md#snapshotprojectversion)
- [diffProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#diffprojectmigrations)
- [scaffoldProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#scaffoldprojectmigrations)
- [verifyProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#verifyprojectmigrations)
- [doctorProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#doctorprojectmigrations)
- [fixturesProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#fixturesprojectmigrations)
- [fuzzProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#fuzzprojectmigrations)
- [seedProjectMigrations](packages_wp_typia_project_tools_src_runtime_migrations.md#seedprojectmigrations)

## References

### formatDiffReport

Re-exports [formatDiffReport](packages_wp_typia_project_tools_src_runtime_migration_render.md#formatdiffreport)
...
Multi-line usage text for the `wp-typia migrate` command surface.
...
▸ **parseMigrationArgs**(`argv`): [`ParsedMigrationArgs`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.ParsedMigrationArgs.md)
...
| :------ | :------ | :------ |
| `argv` | `string`[] | Command-line arguments that follow the `migrate` subcommand. |

#### Returns

[`ParsedMigrationArgs`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.ParsedMigrationArgs.md)
...
▸ **runMigrationCommand**(`command`, `cwd`, `options?`): [`MigrationProjectState`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationProjectState.md) \| [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) \| `MigrationPlanSummary` \| `Promise`\<`MigrationPlanSummary` \| \{ `cancelled`: ``true``  }\> \| \{ `block`: [`ResolvedMigrationBlockTarget`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.ResolvedMigrationBlockTarget.md) ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md)  }[] \| \{ `blockName`: `string` ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) ; `rulePath`: `string`  } \| \{ `scaffolded`: \{ `blockName`: `string` ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) ; `rulePath`: `string`  }[]  } \| \{ `verifiedVersions`: `string`[] = targetVersions } \| \{ `checkedVersions`: `string`[] = targetVersions; `checks`: \{ `detail`: `string` ; `label`: `string` ; `status`: ``"fail"`` \| ``"pass"``  }[]  } \| \{ `generatedVersions`: `string`[] ; `skippedVersions`: `string`[]  } \| \{ `fuzzedVersions`: `never`[] = []; `seed`: `undefined`  } \| \{ `fuzzedVersions`: `string`[] = targetVersions; `seed`: `undefined` \| `number`  }
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `command` | [`ParsedMigrationArgs`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.ParsedMigrationArgs.md) | Parsed migration command and flags. |
...
[`MigrationProjectState`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationProjectState.md) \| [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) \| `MigrationPlanSummary` \| `Promise`\<`MigrationPlanSummary` \| \{ `cancelled`: ``true``  }\> \| \{ `block`: [`ResolvedMigrationBlockTarget`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.ResolvedMigrationBlockTarget.md) ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md)  }[] \| \{ `blockName`: `string` ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) ; `rulePath`: `string`  } \| \{ `scaffolded`: \{ `blockName`: `string` ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) ; `rulePath`: `string`  }[]  } \| \{ `verifiedVersions`: `string`[] = targetVersions } \| \{ `checkedVersions`: `string`[] = targetVersions; `checks`: \{ `detail`: `string` ; `label`: `string` ; `status`: ``"fail"`` \| ``"pass"``  }[]  } \| \{ `generatedVersions`: `string`[] ; `skippedVersions`: `string`[]  } \| \{ `fuzzedVersions`: `never`[] = []; `seed`: `undefined`  } \| \{ `fuzzedVersions`: `string`[] = targetVersions; `seed`: `undefined` \| `number`  }
...
▸ **initProjectMigrations**(`projectDir`, `currentMigrationVersion`, `options?`): [`MigrationProjectState`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationProjectState.md)
...
▸ **snapshotProjectVersion**(`projectDir`, `migrationVersion`, `options?`): [`MigrationProjectState`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationProjectState.md)
...
▸ **diffProjectMigrations**(`projectDir`, `options?`): [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) \| \{ `block`: [`ResolvedMigrationBlockTarget`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.ResolvedMigrationBlockTarget.md) ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md)  }[]
...
[`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) \| \{ `block`: [`ResolvedMigrationBlockTarget`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.ResolvedMigrationBlockTarget.md) ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md)  }[]
...
▸ **scaffoldProjectMigrations**(`projectDir`, `options?`): \{ `blockName`: `string` ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) ; `rulePath`: `string`  } \| \{ `scaffolded`: \{ `blockName`: `string` ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) ; `rulePath`: `string`  }[]  }
...
\{ `blockName`: `string` ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) ; `rulePath`: `string`  } \| \{ `scaffolded`: \{ `blockName`: `string` ; `diff`: [`MigrationDiff`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationDiff.md) ; `rulePath`: `string`  }[]  }
...
▸ **seedProjectMigrations**(`projectDir`, `currentMigrationVersion`, `blocks`, `options?`): [`MigrationProjectState`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationProjectState.md)
...
| `blocks` | [`MigrationBlockConfig`](../interfaces/packages_wp_typia_project_tools_src_runtime_migration_types.MigrationBlockConfig.md)[] | Block targets to register for migration-aware scaffolding. |
