...
[examples/persistence-examples/src/blocks/counter/api-validators.ts:16](https://github.com/imjlk/wp-typia/blob/main/examples/persistence-examples/src/blocks/counter/api-validators.ts#L16)
