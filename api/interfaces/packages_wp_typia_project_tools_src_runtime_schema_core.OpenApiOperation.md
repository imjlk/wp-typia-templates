...
• `Optional` **parameters**: [`OpenApiParameter`](packages_wp_typia_project_tools_src_runtime_schema_core.OpenApiParameter.md)[]
...
• `Optional` **requestBody**: [`OpenApiRequestBody`](packages_wp_typia_project_tools_src_runtime_schema_core.OpenApiRequestBody.md)
...
• **responses**: `Record`\<`string`, [`OpenApiResponse`](packages_wp_typia_project_tools_src_runtime_schema_core.OpenApiResponse.md)\>
...
• **x-typia-authIntent**: [`EndpointAuthIntent`](../modules/packages_wp_typia_project_tools_src_runtime_schema_core.md#endpointauthintent)
...
• `Optional` **x-wp-typia-authPolicy**: [`EndpointOpenApiAuthMode`](../modules/packages_wp_typia_project_tools_src_runtime_schema_core.md#endpointopenapiauthmode)
...
[packages/wp-typia-project-tools/src/runtime/schema-core.ts:102](https://github.com/imjlk/wp-typia/blob/main/packages/wp-typia-project-tools/src/runtime/schema-core.ts#L102)
