---
title: 'Persistence Block Tutorial: Building Data-Backed Blocks with `wp-typia`'
---
...
- [@wp-typia/rest Documentation](https://github.com/imjlk/wp-typia/blob/main/packages/wp-typia-rest/README.md)
