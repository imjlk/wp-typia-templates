---
title: 'Basic Block Tutorial: Building Your First Typia Block with `wp-typia`'
---
...
- [Snapshot Migration Guide](../guides/migrations.md)
- [Interactivity Template Guide](../guides/interactivity.md)
