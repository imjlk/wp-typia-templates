...
const metadata: Record<GeneratedNames, GeneratedCommandMeta> = {
  'add': {
      name: 'add',
      description: 'Extend an official wp-typia workspace with blocks, integration envs, variations, block styles, transforms, patterns, binding sources, standalone contracts, plugin-level REST resources, workflow abilities, server-only AI features, editor plugins, or hooked blocks.',
