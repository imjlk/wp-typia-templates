...
const requireFromWpTypia = createRequire(path.join(packageRoot, "package.json"));
...
export const PROJECT_TOOLS_ALIASES = {
...
export const WP_TYPIA_EXTERNALS = [
	"@wp-typia/api-client",
	"@wp-typia/api-client/*",
...
export async function ensureRuntimeBuildDependencies() {
