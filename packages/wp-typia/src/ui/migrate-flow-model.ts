...
import { sanitizeVisibleSubmitValues } from './submit-value-sanitizers';
...
export function sanitizeMigrateSubmitValues(
  values: MigrateFlowValues,
): Record<string, unknown> {
  return sanitizeVisibleSubmitValues(
    values,
    getVisibleMigrateFieldNames(values),
  );
}
